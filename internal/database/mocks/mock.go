...
import (
	...
	models "github.com/AndyS1mpson/key-value-database/internal/database/compute/models"
...
func (m *MockcomputeLayer) Parse(arg0 string) (*models.Query, error) {
	m.ctrl.T.Helper()
...
func (mr *MockcomputeLayerMockRecorder) Parse(arg0 any) *gomock.Call {
